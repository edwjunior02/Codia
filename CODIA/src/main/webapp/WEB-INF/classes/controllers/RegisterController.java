	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (manager.isComplete(model)) {
				manager.addUser(model.getUser(), model.getMail(), model.getPwd1(), model.getGender(), model.getPhoneNumber(), model.getExperience(), model.getLanguages(), model.getLinkedin());
				manager.finalize();
				view = "Registered.jsp";
		}
